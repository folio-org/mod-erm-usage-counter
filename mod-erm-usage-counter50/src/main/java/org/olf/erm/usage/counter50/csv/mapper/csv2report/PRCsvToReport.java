...
import org.openapitools.counter50.model.COUNTERPlatformUsage.AccessMethodEnum;
import org.openapitools.counter50.model.COUNTERPlatformUsage.DataTypeEnum;
...
public class PRCsvToReport extends AbstractCsvToReport {
  ...
  protected CellProcessor[] createProcessors(List<YearMonth> yearMonths) {
    ...
    List<CellProcessorAdaptor> first =
        Arrays.asList(
            ...
            new Optional(new ParseEnumType<>(COUNTERPlatformUsage.DataTypeEnum.class)), // Data_Type
            new Optional(
                new ParseEnumType<>(COUNTERPlatformUsage.AccessMethodEnum.class)), // Access_Method
  ...
  public String[] createFieldMapping(List<YearMonth> yearMonths) {
    String[] y = yearMonths.stream().map(YearMonth::toString).toArray(String[]::new);
    String[] baseHeader = new String[] {"Platform", "DataType", "AccessMethod", null, null};
